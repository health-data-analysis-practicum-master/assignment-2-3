...
**Due Sunday, March 14 @ midnight through Github**
...
You'll fit a standard logisitic regression and then you will want to figure out a nice data display to allow comparison of the model results. What is an effective way of illustrating how the results compare?
